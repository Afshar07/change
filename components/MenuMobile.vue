<template>
  <nav>
    <ul
      class="flex flex-row-reverse bg-white shadow-sm gap-8 justify-around  bottom-0 p-2"
    >
      <!--home  -->
      <li>
        <NuxtLink
          ...
          target="_self">
        <div
          class="flex justify-center nav-link focus:bg-[#ebf3ff] focus:border-r-4 focus: border-indigo-500"
        >
        ...
        >
          ...
          >
            <g>
              ...
              <path
                xmlns="http://www.w3.org/2000/svg"
                d="M 7.747 14.871 C 7.532 14.783 7.283 14.831 7.117 14.997 L 1.573 20.541 C 1.347 20.767 1.347 21.133 1.573 21.359 L 7.117 26.903 C 7.229 27.015 7.376 27.074 7.526 27.074 C 7.601 27.074 7.675 27.059 7.747 27.029 C 7.964 26.94 8.104 26.729 8.104 26.496 L 8.104 24.096 L 19.582 24.096 C 19.902 24.096 20.161 23.838 20.161 23.518 L 20.161 18.383 C 20.161 18.064 19.902 17.805 19.582 17.805 L 8.104 17.805 L 8.104 15.405 C 8.104 15.171 7.964 14.96 7.747 14.871 Z"
                data-original="#000000"
                class=""
                style="fill: rgb(174, 180, 188)"
              />
            </g>
          </svg>
        </a>
      ...
      <!-- exchanges -->
      <li>
        <a href="/exchanges" class="flex justify-center">
          <svg
            viewBox="0 0 128 128"
            style="enable-background: new 0 0 512 512"
            xmlns="http://www.w3.org/2000/svg"
          ...
          >
            ...
            <path
              style="
                ...
                stroke: rgb(174, 180, 188);
              "
              d="M 40.77 51.663 C 68.077 47.787 85.047 75.296 73.282 94.642 C 61.517 113.988 36.379 114.379 23.986 96.114 C 21.955 93.121 20.09 90.312 18.801 80.779"
              transform="matrix(0.842163, -0.539224, 0.539224, 0.842163, -35.783447, 38.537018)"
            />
          </svg>
        </a>
      ...
      <!-- wallet -->
      <li>
        <a href="/wallet" class="flex justify-center">
          <svg
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
            width="30"
          ...
          >
            <g>
              ...
              />
              <path
                d="M5.5 3H21v5H5.5a2.5 2.5 0 0 1 0-5z"
                style="fill: rgb(112, 122, 138)"
              />
